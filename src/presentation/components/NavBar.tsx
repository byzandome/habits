...
import navbarContent from '@/shared/content/navbar.content';
...
const NAV_ITEMS: NavItem[] = [
  { to: '/', label: 'dashboard', icon: <House size={ICON_SIZE} /> },
  { to: '/history', label: 'timeline', icon: <History size={ICON_SIZE} /> },
  { to: '/apps', label: 'appUsage', icon: <CirclePile size={ICON_SIZE} /> },
  { to: '/settings', label: 'settings', icon: <Cog size={ICON_SIZE} /> },
];
